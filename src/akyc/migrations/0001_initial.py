    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('business_role', models.CharField(blank=True, max_length=255, null=True)),
                ('trading_industry', models.CharField(blank=True, max_length=255, null=True)),
